...
export const pickMovieDetails = (id, setState) => {
    axios.get(`https://api.themoviedb.org/3/movie/${id}?api_key=39600c8af0462aa8d9aa27925348b959&language=pt-BR`)
    .then((response)=>{
        setState(response.data) //Pega apenas os resultados importantes
    }).catch((erro) => {
        console.log(erro)
    })
}
